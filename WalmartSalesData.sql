...
GROUP BY time_of_day
ORDER BY avg_rating DESC;
-- It appears that time of the day does not really affect the rating, it's more or less the same rating each time of the day. However, the afternoon edges out.
